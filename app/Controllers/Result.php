                ...
                if ($b2['session'] == $result['Session']) {
                    if ($b2['gt_id'] == '1') {
                        ...
                        if ($b2['Open_Digits'] == $dig) {
                            ...
                            $model1 = new BidModel();
                            $nn = $model1->getdataforwin($b2['b_id']);
                            $nam = (array)$nn[0];
                            ...
                            $gt_name = $nam['gt_name'];
                            $user_id = $b2['user_id'];
                            $user_name = $nam['user_name'];
                            $b_id = $b2['b_id'];
                            $session = $b2['session'];
                            $Close_Digits = $b2['Close_Digits'];
                            $Open_Digits = $b2['Open_Digits'];
                            $Jodi = $b2['Jodi'];
                            $Open_Panna = $b2['Open_Panna'];
                            $Close_Panna = $b2['Close_Panna'];
